        ...
        <div className="introduce">
            ...
            <div className="introduce-content">
                <p className="introduce-content-title">
                    <b>Ismart</b> là đơn vị kinh doanh với các lĩnh vực đa đạng
                    như công nghệ thông tin, điện năng lượng tái tạo và dịch vụ
                    chăm sóc điện gia đình, doanh nghiệp.{" "}
                </p>
                ...
                <p className="introduce-content-title">
                    Luôn tôn trọng khách hàng, <b>Ismart</b> cũng nhận thức được
                    mỗi khách hàng làm một cá thể cần được tôn trọng, quan tâm,
                    thấu hiểu và phục vụ một cách riêng biệt. Chính vì vậy, nâng
                    cao chất lượng dịch vụ, liên tục đổi mới để thích ứng với
                    thị trường, đáp ứng nhu cầu ngày càng cao của xã hội là điều
                    <b> Ismart</b> luôn chú trọng.
                </p>
                <p className="introduce-content-title">
                    Ngoài ra, <b>Ismart</b> còn luôn quan tâm đến công tác xã
                    hội, hoạt động nhân đạo, phát huy các giá trị:
                </p>
