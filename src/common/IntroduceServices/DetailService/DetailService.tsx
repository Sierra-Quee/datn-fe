            ...
            >
                <Flex className="detailService-mainInfo" vertical>
                    ...
                    <Flex vertical className="detailService-content" gap={10}>
                        ...
                        />
                        <Text strong>
                            * Đơn giá chỉ gồm phí sửa chữa, không bao gồm phí
                            linh kiện sửa chữa. Khách hàng có thể chọn tự mua
                            linh kiện cần thay thế, lắp đặt hoặc yêu cầu nhân
                            viên sửa chữa mua, giá linh kiện sẽ được tính vào
                            hóa đơn cuối cùng.
                        </Text>
                    </Flex>
